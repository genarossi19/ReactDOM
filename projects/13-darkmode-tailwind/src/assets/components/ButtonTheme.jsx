...
function ButtonTheme() {
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center dark:bg-neutral-900 transition-colors duration-500">
      ...
      <div id="textos" className="">
        <h1 className="p-4 m-4 text-xl font-bold dark:text-white transition-all duration-500 ">
          HOLA
        </h1>
        <p className="  p-4 m-8 text-xl font-light dark:text-white transition-all duration-500 ">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ea
          blanditiis sint doloribus natus possimus, repellendus fugiat quae
          aliquid! Nobis, sunt.
        </p>
      </div>
    </div>
